// Simple test script to verify ATS scoring engine
const { ATSScoringEngine } = require('./lib/analysis/ats-scoring-engine.ts');
...
async function testATSScoring() {
  try {
    ...
    // Initialize the ATS scoring engine
    ...
    console.log('ATS Score Result:', JSON.stringify(atsScore, null, 2));
